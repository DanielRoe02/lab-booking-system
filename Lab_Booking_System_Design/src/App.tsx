  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          currentUser?.role === 'internal' ? (
            <LabAvailability user={currentUser} onLogout={handleLogout} />
          ) : (
            <Navigate to="/login" />
          )
        }
      ...
      <Route
        ...
        element={
          currentUser?.role === 'internal' ? (
            <BookingRequest user={currentUser} onLogout={handleLogout} />
          ) : (
            <Navigate to="/login" />
          )
        }
      ...
      <Route
        ...
        element={
          currentUser?.role === 'internal' ? (
            <MyBookings user={currentUser} onLogout={handleLogout} />
          ) : (
            <Navigate to="/login" />
          )
        }
      ...
      <Route
        ...
        element={
          currentUser?.role === 'internal' ? (
            <ModifyBooking user={currentUser} onLogout={handleLogout} />
          ) : (
            <Navigate to="/login" />
          )
        }
      ...
      <Route
        ...
        element={
          currentUser?.role === 'internal' ? (
            <CancelBooking user={currentUser} onLogout={handleLogout} />
          ) : (
            <Navigate to="/login" />
          )
        }
      ...
      <Route
        ...
        element={
          currentUser?.role === 'external' ? (
            <ExternalDashboard user={currentUser} onLogout={handleLogout} />
          ) : (
            <Navigate to="/login" />
          )
        }
      ...
      <Route
        ...
        element={
          currentUser?.role === 'external' ? (
            <PaymentPage user={currentUser} onLogout={handleLogout} />
          ) : (
            <Navigate to="/login" />
          )
        }
      ...
      <Route
        ...
        element={
          currentUser?.role === 'external' ? (
            <PaymentProcessing user={currentUser} onLogout={handleLogout} />
          ) : (
            <Navigate to="/login" />
          )
        }
      ...
      <Route
        ...
        element={
          currentUser?.role === 'external' ? (
            <PaymentConfirmation user={currentUser} onLogout={handleLogout} />
          ) : (
            <Navigate to="/login" />
          )
        }
      ...
      <Route
        ...
        element={
          currentUser?.role === 'admin' ? (
            <BookingApproval user={currentUser} onLogout={handleLogout} />
          ) : (
            <Navigate to="/login" />
          )
        }
      ...
      <Route
        ...
        element={
          currentUser?.role === 'admin' ? (
            <LabManagement user={currentUser} onLogout={handleLogout} />
          ) : (
            <Navigate to="/login" />
          )
        }
      ...
      <Route
        ...
        element={
          currentUser?.role === 'admin' ? (
            <LabUsageMonitoring user={currentUser} onLogout={handleLogout} />
          ) : (
            <Navigate to="/login" />
          )
        }
      ...
      <Route
        ...
        element={
          currentUser?.role === 'admin' ? (
            <NotificationManagement user={currentUser} onLogout={handleLogout} />
          ) : (
            <Navigate to="/login" />
          )
        }
